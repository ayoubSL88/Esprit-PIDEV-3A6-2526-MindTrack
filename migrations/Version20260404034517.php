 ...
 */
final class Version20260404034517 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // utilisateur.id_u must exist before creating foreign keys referencing it
        $this->addSql('ALTER TABLE profilpsychologique DROP FOREIGN KEY `fk_profil_user`');
        $this->addSql('ALTER TABLE utilisateur ADD id_u INT NOT NULL, ADD nom_u VARCHAR(255) NOT NULL, ADD prenom_u VARCHAR(255) NOT NULL, ADD email_u VARCHAR(255) NOT NULL, ADD mdps_u VARCHAR(255) NOT NULL, ADD age_u INT NOT NULL, ADD role_u VARCHAR(20) NOT NULL, DROP idU, DROP nomU, DROP prenomU, DROP emailU, DROP mdpsU, DROP ageU, DROP roleU, CHANGE face_subject face_subject VARCHAR(255) NOT NULL, CHANGE face_image_id face_image_id VARCHAR(64) NOT NULL, CHANGE face_enabled face_enabled TINYINT NOT NULL, CHANGE profile_picture_path profile_picture_path VARCHAR(512) NOT NULL, CHANGE totp_secret totp_secret VARCHAR(128) NOT NULL, CHANGE totp_enabled totp_enabled TINYINT NOT NULL, DROP PRIMARY KEY, ADD PRIMARY KEY (id_u)');
        ...
        $this->addSql('CREATE INDEX IDX_9E5225F2672EC9EB ON planaction (idObj)');
        $this->addSql('DROP INDEX idx_plan_objectif ON planaction');
        ...
        $this->addSql('CREATE INDEX IDX_C4294AE0437E1404 ON rappel_habitude (idHabitude)');
        $this->addSql('DROP INDEX fk_rappel_habitude ON rappel_habitude');
        ...
        $this->addSql('DROP INDEX idEx ON session');
        ...
        $this->addSql('CREATE INDEX IDX_E1522B87437E1404 ON suivihabitude (idHabitude)');
        $this->addSql('DROP INDEX idx_suivi_habitude ON suivihabitude');
        ...
        $this->addSql('CREATE INDEX IDX_5A0EB6A0B7BBED16 ON todo (idExercice)');
        $this->addSql('DROP INDEX idExercice ON todo');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('CREATE INDEX idx_jalon_obj ON jalonprogression (idObj)');
        $this->addSql('DROP INDEX IDX_2A71AD13672EC9EB ON jalonprogression');
        ...
        $this->addSql('CREATE INDEX idx_plan_objectif ON planaction (idObj)');
        $this->addSql('DROP INDEX IDX_9E5225F2672EC9EB ON planaction');
        ...
        $this->addSql('CREATE INDEX fk_rappel_habitude ON rappel_habitude (idHabitude)');
        $this->addSql('DROP INDEX IDX_C4294AE0437E1404 ON rappel_habitude');
        ...
        $this->addSql('CREATE INDEX idEx ON session (idEx)');
        $this->addSql('DROP INDEX IDX_D044D5D4FB644627 ON session');
        ...
        $this->addSql('CREATE INDEX idx_suivi_habitude ON suivihabitude (idHabitude)');
        $this->addSql('DROP INDEX IDX_E1522B87437E1404 ON suivihabitude');
